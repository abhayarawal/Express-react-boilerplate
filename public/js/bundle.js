...
var _react_fluxComponentsApp_component = require('./react_flux/components/app_component');

var _react_fluxComponentsApp_component2 = _interopRequireDefault(_react_fluxComponentsApp_component);
...
var ConnectForm = _react2['default'].createClass({
	displayName: 'ConnectForm',

	handleSubmit: function handleSubmit(e) {
		e.preventDefault();

		var location = _react2['default'].findDOMNode(this.refs.location).value.trim();
		if (location.length === 4) {
			this.props.connectNode(location);
			_react2['default'].findDOMNode(this.refs.location).value = '';
		}
...
var PlayerComponent = _react2['default'].createClass({
	...
	update$sid: function update$sid(params) {
		...
		var timestamp = _state.timestamp;
	...
	handleNodeConnect: function handleNodeConnect(location) {
...
var AppComponent = _react2['default'].createClass({
	...
	render: function render() {
		return _react2['default'].createElement(
			'div',
			null,
			_react2['default'].createElement(PlayerComponent, null)
		);
	}
});
...
},{"moment":5,"react":160}],3:[function(require,module,exports){
'use strict';

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { 'default': obj }; }

var _appAssetsEs6Loader = require('./app/assets/es6/loader');

var _appAssetsEs6Loader2 = _interopRequireDefault(_appAssetsEs6Loader);

},{"./app/assets/es6/loader":1}],4:[function(require,module,exports){
